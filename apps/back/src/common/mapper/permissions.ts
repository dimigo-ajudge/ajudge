export const UserPermissionValues = ["COMMENTER", "MODERATOR"] as const;

export const ManagementPermissionValues = ["ADMIN"] as const;
...
export const CommenterUserPermission: number[] = [PermissionEnum.COMMENTER];
export const ModeratorUserPermission: number[] = [PermissionEnum.MODERATOR];
export const AdminUserPermission: number[] = Object.values(PermissionEnum);

export const PermissionGroups = {
  CommenterUserPermission,
  ModeratorUserPermission,
  AdminUserPermission,
};
